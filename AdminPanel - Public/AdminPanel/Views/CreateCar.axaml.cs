        ...
        private async void OnSearchAddress(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (results != null && results.Count > 0)
                {
                    ...
                    _viewModel.Latitude = result.Latitude.Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator);
                    _viewModel.Longitude = result.Longitude.Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator);
