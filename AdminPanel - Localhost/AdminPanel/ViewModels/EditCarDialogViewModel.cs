        ...
        private async Task SearchAddress()
        {
            ...
            try
            {
                ...
                if (results != null && results.Count > 0)
                {
                    ...
                    if (double.TryParse(result.Latitude, NumberStyles.Float, CultureInfo.InvariantCulture, out double lat) &&
                        double.TryParse(result.Longitude, NumberStyles.Float, CultureInfo.InvariantCulture, out double lon))
                    {
