...
namespace AdminPanel.ViewModels
{
    public class EditCarDialogViewModel : ViewModelBase
    {
        ...
        public EditCarDialogViewModel(CarListing car, Window dialog, HttpClient httpClient = null)
        {
        ...
        private async Task SearchAddress()
        {
            ...
            try
            {
                _httpClient.DefaultRequestHeaders.Add("User-Agent", "frocar (frocar@gmail.com)");
        ...
        private async Task Save()
        {
            try
            {
                ...
                {
                    errors.Add("Pojemność silnika musi być poprawną liczbą.");
                }
                else if (engineCapacity <= 0)
                {
                    errors.Add("Pojemność silnika musi być większa od 0.");
                }
                else
                {
                ...
                {
                    errors.Add("Liczba miejsc musi być poprawną liczbą całkowitą.");
                }
                else if (seats <= 0)
                {
                    errors.Add("Liczba miejsc musi być większa od 0.");
                }
                else
                {
                ...
                {
                    errors.Add("Cena za dzień musi być poprawną liczbą.");
                }
                else if (rentalPrice <= 0)
                {
                    errors.Add("Cena za dzień musi być większa od 0.");
                }
                else
                {
                ...
                {
                    errors.Add("Szerokość geograficzna musi być poprawną liczbą.");
                }
                else
                {
                    CarListing.Latitude = lat;
                ...
                {
                    errors.Add("Długość geograficzna musi być poprawną liczbą.");
                }
                else
                {
                    CarListing.Longitude = lon;
